...
export default function Sidebar({
  user = { name: 'Adil', email: 'multi.xpert5r@gmail.com', initial: 'A' },
  sites = [],
  sitesLoading = false,
  onAddSiteClick,
}) {
  ...
  return (
    <aside style={{
      ...
      <div style={{ marginBottom: 16 }}>
        ...
        {sitesLoading && (
          <p style={{ fontSize: 12.5, color: '#a1a1aa', padding: '4px 10px' }}>Loading...</p>
        )}
        ...
        {!sitesLoading && sites.length === 0 && (
          <button
            ...
            style={{
              ...
              padding: '8px 10px', borderRadius: 8, border: '1px dashed #d4d4d8', background: 'none',
              cursor: 'pointer', color: '#71717a', fontSize: 12.5,
            }}
          >
